...
<meta name="twitter:site" content="@RojgarVala">
<meta name="twitter:title" content="{{ $meta_title ?? 'Rojgar Vala New Job Updates' }}">
<meta name="twitter:description" content="{{ $meta_description ?? 'Rojgar Vala provides new job updates and preparation tips.' }}">
<meta name="twitter:image" content="{{ $meta_image ?? asset('front/images/comlogo.webp') }}">
